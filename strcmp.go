...
// zendiSmartStrcmp_PHP7 is port of zendi_smart_strcmp from php-src:7.4.
func zendiSmartStrcmp_PHP7(s1, s2 string) int {
	ret1, _, lval1, dval1, _ := isNumericStringEx_PHP7(s1)
	ret2, _, lval2, dval2, _ := isNumericStringEx_PHP7(s2)
...
// isNumericStringEx_PHP7 is PHP7 implementation of `is_numeric_string_ex`
//
// see:
//   - https://wiki.php.net/rfc/saner-numeric-strings
//   - https://github.com/php/php-src/blob/15846ff115722b2f95d699abf07141d774b0e2cd/Zend/zend_operators.c#L2900-L3028
func isNumericStringEx_PHP7(str string) (uint8, int, int64, float64, bool) {
	// Check if the string is a numeric string
	length := len(str)
	if length == 0 {
		return 0, 0, 0, 0, false
